...
class BareMetalNodesTest(test.TestCase):
    ...
    def test_add_interface(self):
        ...
        self.mox.ReplayAll()
        res_dict = self.controller.action(self.request, node_id,
                                          {'add_interface': data})
    ...
    def test_remove_interface(self):
        ...
        self.mox.ReplayAll()
        self.controller.action(self.request,
                               node_id,
                               {'remove_interface': {'id': 2}})
    ...
    def test_remove_interface_by_address(self):
        ...
        self.controller.action(self.request, node_id, body)
    ...
    def test_action_node_not_found(self):
        node_id = 1
        self.mox.StubOutWithMock(db, 'bm_node_get')
        db.bm_node_get(self.context, node_id).\
        ...
        self.assertRaises(exc.HTTPNotFound,
                          ...
                          self.request,
                          node_id,
                          {'add_interface': {'address': '11:11:11:11:11:11'}})
